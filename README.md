...
Elicit, scite, Connected Papers, ResearchRabbit ask *what does the literature say?* This toolkit asks *does the literature deserve its confidence?* Not a literature-review tool. A **consensus stress-test tool.**

**The workflow:**
Most people use AI like this: ask question → receive consensus answer → accept summary.
This toolkit forces: domain suspicion → construct audit → citation audit → field diagnostic → adversarial stress test → public receipts.

**Who this is for:**
Anyone who has been told something is true and wants to know if the evidence actually supports it. Domain experts will get the most out of it — but the core question (“does this metric measure the same thing as this claim?”) requires no credentials. A citizen auditing their school district, a voter stress-testing a politician’s crime statistics, a patient interrogating a drug study, a journalist checking whether a headline matches the underlying data — all can use this method. The more domain knowledge you bring, the sharper the audit. The method works at any level of expertise.

**What you can produce:** academic papers, Substack posts, op-eds, policy briefs, PubPeer comments, personal audits of claims you’ve been told are settled. The method applies to academic literature, news, policy, corporate communications, political platforms, medical studies, educational outcomes — any domain where institutional claims are made and metrics are selected.
...
Paper 1 built a positive biological-plus-funnel model. Paper 2 documented the citation network, proxy failures, level-of-analysis errors, and untested premise. The full documentation is in [WORKED_EXAMPLES.md](https://github.com/yungmulaBABY1/the-same-four-failures-or-field-map-adversarial-research/blob/main/WORKED_EXAMPLES.md).
