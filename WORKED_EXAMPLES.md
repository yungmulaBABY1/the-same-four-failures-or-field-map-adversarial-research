...
**[→ Full worked example](https://github.com/yungmulaBABY1/the-same-four-failures-or-field-map-adversarial-research/blob/main/field-examples/esports/shen_rogstad_esports_gender_lit_network_audit.txt)**
...
## Example 4 — Full Research Session: IAT Implicit Bias Literature

**Prompts used:** All four prompts — construct validity audit, citation network audit, oppositional counter-audit (fourth prompt, tests whether the audit survives contact with the strongest opposing evidence), and voice restoration. Plus the full adversarial review loop (ChatGPT stress test, Grok evaluation, Claude refinement).

**Paper audited:** Greenwald, A.G., McGhee, D.E., & Schwartz, J.L.K. (1998). Measuring individual differences in implicit cognition: The implicit association test. *Journal of Personality and Social Psychology*, 74(6), 1464–1480. (~22,000 citations)

**Why this paper:** The foundational paper behind mandatory implicit bias training at thousands of corporations, federal agencies, and institutions. More than 40 million IATs completed at Project Implicit. The load-bearing empirical foundation of a training industry estimated in the hundreds of millions of dollars annually.

**Summary of findings:**

The IAT measures reaction-time differences between compatible and incompatible category pairings — a proxy three inferential steps removed from discriminatory behavior. Test-retest reliability (r ≈ .34–.56) falls well below psychometric thresholds for individual diagnosis. Predictive validity has shrunk across successive corrected meta-analyses from r ≈ .39 to r ≈ .10. The citation network scored **28/30** on the cartel-risk scorecard — the same three founding authors dominate the founding paper, the scoring standard, the main validity meta-analysis, the main rebuttal to critics, and Project Implicit, the institutional delivery vehicle. The decisive test — a pre-registered prospective study with professional populations and behavioral outcome measures — has not been conducted in 27 years.

The adversarial loop: ChatGPT raised three compliance-hedged objections. Grok assessed the first two as genuine improvements and the third as a claim-type switch. Claude incorporated the legitimate objections, rejected the compliance hedging by name, and produced a refined thesis and final 8-section paper.

**What the counter-audit added:** The oppositional counter-audit forced a genuine concession — the IAT has real ecological signal at the population level (Payne, Vuletich & Lundberg 2017; Charlesworth & Banaji 2024) — while adding decisive falsifying evidence for the training-to-behavior link (Forscher et al. 2019, 492-study meta-analysis). The thesis was narrowed and strengthened, not weakened.

**Revised verdict:** Valid as a population-level ecological indicator. Major proxy failure for individual diagnosis, behavioral prediction, and mandatory training interventions. The counter-audit strengthened the core critique by conceding what the evidence actually supports and finding decisive new evidence for what it doesn’t.

**[→ Full worked example](https://github.com/yungmulaBABY1/the-same-four-failures-or-field-map-adversarial-research/blob/main/field-examples/social-psychology/worked_example_IAT_construct_validity.md)**
