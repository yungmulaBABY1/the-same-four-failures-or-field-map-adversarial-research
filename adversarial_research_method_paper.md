...
> domain suspicion → construct audit → internal validity audit → citation audit → field diagnostic → adversarial stress test → public receipts
...
**Stage 6: Run the adversarial loop.**
