...
**Stage 6: Add domain knowledge.** Practitioner observations, unindexed community knowledge, adjacent fields the literature ignored. Test additions conversationally: is this actually supported or am I motivated reasoning?
...
All prompts are publicly available in the GitHub repository. They are free, reusable, and domain-agnostic. Run them in the order listed below — the field diagnostic establishes the structural pattern before any specific study is audited.
...
1. **Archive everything** — public evidence bundle, source-status labels, correction log
   9.5. **Run the oppositional counter-audit** — find the strongest evidence for the other side before publishing. What survives this is what gets published.
   9.6. **Run voice restoration** — check the final version for compliance softening before publishing.
